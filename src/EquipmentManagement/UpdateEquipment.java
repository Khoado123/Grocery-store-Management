            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtequipmentid, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtcreatedate, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtequipmentid, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
// Lấy chỉ mục hàng đã chọn trong bảng tblEquipment
    ...
    private void tblEquipmentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEquipmentMouseClicked
        ...
        if (row >= 0) {
            // Lấy dữ liệu từ hàng đã chọn
            String id = tblEquipment.getValueAt(row, 0).toString();
            String name = tblEquipment.getValueAt(row, 1).toString();
            String type = tblEquipment.getValueAt(row, 2).toString();
            float price = Float.parseFloat(tblEquipment.getValueAt(row, 3).toString());
            String status = tblEquipment.getValueAt(row, 4).toString();
            String createBy = tblEquipment.getValueAt(row, 5).toString();
            String createDateStr = tblEquipment.getValueAt(row, 6).toString();

            // Hiển thị dữ liệu lên các thành phần trên giao diện người dùng
            txtequipmentid.setText(id);
